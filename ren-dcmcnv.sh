...
# Version 1.2.1
# 09-Oct-2017 K.Nemoto

# Usage: ren-dcncnv.sh [-d]
# -d: option not to delete temporary files generated by dcm2nii
...
if [ $debug == "d" ]; then
    ...
    echo "debug option is disabled. (Default)"
    echo " "
fi
...
#If debug option is not enabled, delete remained nifti and bv{al,ec} files
if [ $debug != "d" ]; then
    echo "Delete temprary files"
    echo " "
